      ...
      <div>
        ...
        <div className="mb-16">
          <div className="max-w-7xl mx-auto pb-16 flex">
            ...
            <sup className="text-4xl">&copy;</sup>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 text-xs max-w-7xl mx-auto">
          ...
          {/* Center: Legal Links */}
          <nav className="flex flex-wrap gap-x-6 gap-y-2 order-3 md:order-2 w-full md:w-auto justify-start md:justify-center text-white">
            {bottomNav.map((item) => (
              <Link
                key={item.name}
                href={item.href}
          ...
          <button className="flex items-center text-white gap-1 hover:text-white transition-colors order-2 md:order-3 self-end md:self-center">
